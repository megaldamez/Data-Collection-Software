...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Loading DLL and Init US-key %serial
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% DataAngle1 = zeros(NumCol,NumFrm);
...
%     writePosition(s, 1);
    ...
    DataArray2(i,:) = mean(DataArray,2);
%     DataArray2 = reshape(DataArray2,1,Len);
%     clear s
    pause(30)
end
...
save(fullfile('C:\Users\Tsumura\Downloads\DLL_USKEY_x64','MQP3.mat'),'-v7.3')
